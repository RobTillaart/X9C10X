...
This **experimental** library provides a X9C10X class and 
...
Multiple devices can be controlled by giving them an unique selectPin (CS).
...
This class is similar to th X9C class but added position, Ohm and type information.
...
- **void begin(uint8_t pulsePin, uint8_t directionPin, uint8_t selectPin)** 
sets the pins used by the device. Inherited from X9C.
